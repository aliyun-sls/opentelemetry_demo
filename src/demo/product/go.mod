...
require (
	github.com/alibabacloud-go/darabonba-openapi/v2 v2.2.0
	...
	sls-mall-go/common v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/aliyun-sls/opentelemetry-go-provider-sls v0.13.0 // indirect
...
replace sls-mall-go/common => ../common
