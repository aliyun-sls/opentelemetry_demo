...
import static com.alibaba.arms.mock.server.service.trouble.DirectTrouble.PARAM_FULL_METHOD_KEY;
    ...
    public void cancelInjectError(String componentName) {
        ...
        if (null == troubleInjector) {
            ...
            if (null == component) {
                ...
                params.put(PARAM_FULL_METHOD_KEY, fullClassName + "#" + methodName);
